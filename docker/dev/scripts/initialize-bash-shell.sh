...
export ROS_PACKAGE_PATH=${ROS_PACKAGE_PATH}:/root/dipcom_env/catkin_ws/src/
export ROS_PACKAGE_PATH=${ROS_PACKAGE_PATH}:/root/dipcom_env/underlay_ws/src/
...
function osx-repair-git-paths () {
  ...
  pushd .
  source /root/dipcom_env/docker/dev/scripts/repair-git-paths.sh
  popd
}
...
function osx-fix-permission-issues () {
  ...
  pushd .
  source /root/dipcom_env/docker/dev/scripts/repair-git-paths.sh
  source /root/dipcom_env/docker/dev/scripts/fix-permission-issues.sh
  popd
}
